...
def test(a):
    return _LSystem.test(a)
test = _LSystem.test

def test0(a):
    return _LSystem.test0(a)
test0 = _LSystem.test0
class LSystem(_object):
    ...
    __repr__ = _swig_repr
    if _newclass:
        test2 = staticmethod(_LSystem.LSystem_test2)
    else:
        test2 = _LSystem.LSystem_test2

    def test3(self, a):
        return _LSystem.LSystem_test3(self, a)
...
def LSystem_test2(a):
    return _LSystem.LSystem_test2(a)
LSystem_test2 = _LSystem.LSystem_test2
